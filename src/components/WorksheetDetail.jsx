    ...
    return (
        <div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6 shadow-sm">
                ...
                <DetailField label="Who angers, confuses, or disappoints you, and why?" value={worksheet.person} />
                <DetailField label="How do you want them to change? What do you want them to do?" value={worksheet.wantChange} />
                <DetailField label="What advice would you offer to them?" value={worksheet.advice} />
                <DetailField label="In order for you to be happy, what do you need them to think, say, feel, or do?" value={worksheet.needHappy} />
            </div>

            {worksheet.statements && worksheet.statements.length > 0 && (
...
function StatementDetail({ statement, number }) {
    ...
    return (
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6 shadow-sm">
            ...
            {statement.statement && (
                <DetailField label="Statement:" value={statement.statement} />
            )}
            <DetailField label="Question 1: Is it true?" value={statement.q1True} />
            <DetailField label="Question 2: Can you absolutely know it's true?" value={statement.q2Absolutely} />
            <DetailField label="Question 3: How do you react when you believe that thought?" value={statement.q3React} />
            <DetailField label="Question 4: Who would you be without that thought?" value={statement.q4Without} />
