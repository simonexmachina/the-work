...
function App() {
    const { user, loading: authLoading, authService, signUp, signIn, signOut, isAuthenticated } = useAuth();
    const { worksheets, loadWorksheets, getWorksheet, saveWorksheet, deleteWorksheet } = useDatabase();
    ...
    const handleSyncEvent = (event, data) => {
        ...
        } else if (event === 'worksheet-added' || event === 'worksheet-updated' || event === 'worksheet-deleted') {
            loadWorksheets();
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <main>
                <Routes>
                    <Route 
                        path="/" 
                        element={<ListView worksheets={worksheets} />} 
                    />
                    <Route 
                        path="/worksheet" 
                        element={
